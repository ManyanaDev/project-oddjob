...
import { cn } from "@oddjob/ui/lib/utils";
...
const buttonVariants = cva(baseClasses, {
  variants: {
    variant: {
      ...
      twGhost: "hover:tw-bg-accent hover:tw-text-accent-foreground",
      twLink: "tw-text-primary tw-underline-offset-4 hover:tw-underline",
    },
    size: {
      ...
      twDefault: "tw-h-10 tw-px-4 tw-py-2",
      twSm: "tw-h-9 tw-rounded-md tw-px-3",
      twLg: "tw-h-11 tw-rounded-md tw-px-8",
      twIcon: "tw-h-10 tw-w-10",
    },
  },
  defaultVariants: {
    variant: "default",
